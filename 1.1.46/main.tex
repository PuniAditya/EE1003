...
\begin{figure}
    \centering
    \includegraphics[width=0.5\columnwidth]{figs/time_resp.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\columnwidth]{figs/freq_response.jpg}
    \caption{Magnitude of Transfer Function vs. Angular Frequency $\omega$}
	\label{fig:freq}
\end{figure}
The frequency response further confirms our theoretical steady-state analysis. The magnitude $|H(j\omega)|$ never drops to zero at any real frequency, proving that the bridge cannot be balanced.
\end{frame}
